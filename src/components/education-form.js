            ...
            <span id="form-section-title">Education</span>
                {this.props.educationItems.map((item, index) => {
                    ...
                    <form id="education-item-form">
                        ...
                        <textarea id={index} name="description" placeholder="GPA, extracurriculars, awards/honors, relevant coursework, etc." value={item.description} onChange={this.handleInputChange}></textarea>
